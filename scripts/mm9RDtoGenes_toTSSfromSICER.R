...
res <- merged2.res[,qw(peak,space,start,end,width,nTags_ChIP,nTags_Cnt,neg10log10pVal,FoldEnrichment,FDR,feature,strand,start_position,end_position,insideFeature,distancetoFeature,shortestDistance,fromOverlappingOrNearest,mgi_symbol,description)]
colnames(res) <- qw(Peak,Chromosome,Peak_start,Peak_end,Peak_width,nTags_ChIP,nTags_Cnt,neg10log10pVal,FoldEnrichment,FDR,EnsemblID,Gene_strand,Gene_start,Gene_end,insideFeature,distancetoFeature,shortestDistance,fromOverlappingOrNearest,Symbol,Description)
